...
rsync -avz 10.2.16.142:/mnt/3/icdar21/slide/result4paper/$model_name /ssd_scratch/cvit/jobinkv/$SLURM_JOB_ID/$model_name
...
python trainslide.py --dataset $dataset\
  ...
  --template_selection_loss_contri 0.1 --backbone_lr 0.01 --multi_optim --test_mode True
